...
$outgoingServerAddress      = 'mail.millenniumglass.com.au'; // Consult your hosting provider.
...
$websiteName                = 'Millennium Glass';                // REQUIRED value. This is used when a name or email is not collected from the website form
